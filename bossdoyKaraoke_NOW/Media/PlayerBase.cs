...
namespace bossdoyKaraoke_NOW.Media
{
    abstract class PlayerBase
    {
        ...
        private static HashSet<string> _extensions = new HashSet<string>(StringComparer.OrdinalIgnoreCase) { ".cdg", ".mp3", ".vob", ".mp4", ".flv", ".avi", ".mov", ".mkv", ".mpg", ".wav", ".wmv" }; // ".vob", ".mp4", ".flv", ".avi", ".mov", ".mkv", ".mpg", ".wav", ".wmv"
