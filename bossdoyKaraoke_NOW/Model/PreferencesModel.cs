...
namespace bossdoyKaraoke_NOW.Model
{
    ...
    {
        private static PreferencesModel _instance;
        ...
        public static PreferencesModel Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new PreferencesModel();
                }
                return _instance;
            }
        }

        //======Audio device output settings

        /// <summary>
        /// Method to get and set audio ouput divice for bass and nvlc
        /// </summary>
        ...
        /// <summary>
        /// Method to get and set selected ouput divice for bass and nvlc
        /// </summary>
        ...
        /// <summary>
        /// Method to set audio ouput divice for bass and nvlc
        /// </summary>
