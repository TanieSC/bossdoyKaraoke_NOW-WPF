...
public class CDGFile : IDisposable
{
    ...
    public WriteableBitmap RGBImage
    {
        get
        {
            ...
            return GraphicUtil.StreamToBitmap(ref stream, CDG_FULL_WIDTH, CDG_FULL_HEIGHT);
        }
    }

    //Not working
    public byte[] RGBImageBytes
    {
        get
        {
            MemoryStream temp = new MemoryStream();
            ...
            return GraphicUtil.StreamToBytes(ref stream, CDG_FULL_WIDTH, CDG_FULL_HEIGHT);
        }
    }
    #endregion
...
public class ISurface
{
	...
	public int MapRGBColour(int red, int green, int blue)
	{
        ...
        return new Color(red, green, blue).ToBgra();
    }
